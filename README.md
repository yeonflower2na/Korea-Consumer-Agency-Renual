...
| 이름                          | 링크                                                                                               |
|-------------------------------|----------------------------------------------------------------------------------------------------|
| 리뉴얼 홈페이지                | [리뉴얼 홈페이지 Link](https://yeonflower2na.github.io/Korea-Consumer-Agency-Renual/)                                   |
...
## 📂 프로젝트 구성
### 메인 페이지 
- **주요 기능**: 메인 페이지에서는 주요 공지사항 슬라이더, 서비스 배너, 공지사항 팝업 기능을 통해 한국소비자원의 주요 서비스를 한눈에 볼 수 있도록 구성하였습니다.
- **사용자 인터페이스**: 웹 접근성을 고려한 직관적인 UI를 제공하며, 검색창과 상단 메뉴를 명확하게 배치하여 사용자가 쉽게 네비게이션할 수 있도록 설계하였습니다.<br/>
  주요 메뉴는 심플하게 구성하고, 모바일 환경에서도 동일한 경험을 제공하기 위해 반응형 디자인을 적용하였습니다.
<br/>
### 서브 페이지
- **세부 정보 제공**: 서브 페이지에서는 소비자 피해 구제 절차, 정책 자료, 소비자 안전 관련 정보를 명확하게 전달하기 위해 간결하게 제작했습니다.
- **카테고리별 정보 제공**: 서브 페이지는 소비자 피해 구제, 정책 자료 등의 카테고리별로 나누어 정보 접근성을 강화하였습니다.
...
- **디자인 일관성 강화**: 메인과 서브 페이지에서 일관된 디자인 시스템을 적용하여 시각적 정체성을 강화하였습니다.
- **웹 접근성 개선**: 대비가 높은 색상과 명확한 폰트를 사용해 가독성을 높이고, 다양한 사용자의 요구에 맞는 웹 접근성을 제공하였습니다.
- **메뉴 구조 단순화**: 주요 기능과 정보를 직관적으로 배치하여 사용자가 원하는 정보에 쉽게 접근할 수 있도록 개선하였습니다.
...
**다크 테마**는 시각적 피로를 줄이고, 저조도 환경에서 웹사이트를 사용하는 사용자에게 더 나은 가독성을 제공합니다.<br>
배경색과 텍스트의 명확한 대비를 통해 **웹 접근성**을 개선하며, 디자인 일관성을 유지하도록 제작하였습니다.
</div>
<br>
